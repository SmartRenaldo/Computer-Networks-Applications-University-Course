...
while True:
  ...
  # ~~~~ INSERT CODE ~~~~
  message = clientSocket.recv(BUFFER_SIZE).decode('utf8')
  # ~~~~ END CODE INSERT ~~~~
  ...
  # Error handling for file not found in cache
    ...
    if fileExists:
      ...
      # ~~~~ INSERT CODE ~~~~
      clientResponse = version + ' 403 Forbidden'
      # ~~~~ END CODE INSERT ~~~~
      ...
      try:
        ...
        # ~~~~ INSERT CODE ~~~~
        response = originServerFileObj.readlines()
        # ~~~~ END CODE INSERT ~~~~

        # Send the response to the client
        # ~~~~ INSERT CODE ~~~~
        for row in response:
          clientSocket.sendall(row)
        # ~~~~ END CODE INSERT ~~~~
